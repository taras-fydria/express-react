...
var TankController = /** @class */ (function (_super) {
    ...
    function TankController(entity) {
        if (entity === void 0) { entity = Tank_1.default; }
        ...
        _this.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        tanks = _a.sent();
                        return [2 /*return*/, res.json(tanks)];
                }
            });
        }); };
        _this.getTank = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var repo, tank;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repo = this.repository;
                        return [4 /*yield*/, repo.findOne(req.params.id)];
                    case 1:
                        tank = _a.sent();
                        return [2 /*return*/, res.json(tank)];
                }
            });
        }); };
        _this.create = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var repo, tankData, newTank;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        repo = this.repository;
                        tankData = req.body;
                        return [4 /*yield*/, repo.create(tankData)];
                    case 1:
                        newTank = _a.sent();
                        return [2 /*return*/, res.json(newTank)];
                }
            });
        }); };
        return _this;
...
exports.default = new TankController();
